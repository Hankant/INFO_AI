...
\vspace{2.2cm}
{\large English research proposal\par}
\vfill
\begin{tabular}{rl}
Date: & August 27, 2026\\
Status: & Formal proposal; measurement and explanation framework\\
Research stage: & Parameter recovery and validity require pilot testing\\
Primary fields: & Behavioral decision research; AI adoption; management and public policy
\end{tabular}
\vfill
\end{titlepage}
