...
\vspace{1.15cm}
{\sffamily\bfseries\Huge AI Decision Agents, Conflict Escalation,\par}
\vspace{0.18cm}
{\sffamily\bfseries\Huge and Responsibility Attribution\par}
\vspace{0.55cm}
{\sffamily\Large An Incentivized Study of Intergroup Conflict\par}
\vspace{2.0cm}
{\large Paper 3 --- English Research Proposal\par}
\vfill
...
This research proposal was translated and formatted with assistance from AI-powered academic writing tools. The author directed the research design and retains full responsibility for the claims, interpretations, and methodological decisions.
